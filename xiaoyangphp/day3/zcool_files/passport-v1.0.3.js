...
//				 }
			 ...
			 logoutHellorfPre:function(passportHost) {
				 if(passportHost != null && passportHost.indexOf('test') > -1){
					 $z.addScriptTag("http://test.pro.hellorf.com/login/dologout/?callback=$z.logoutCallBack&scriptId=ssoscript1024",'ssoscript1024');
				 }else{
					 $z.addScriptTag("http://pro.hellorf.com/login/dologout/?callback=$z.logoutCallBack&scriptId=ssoscript1014",'ssoscript1014');
				 }
			 },
