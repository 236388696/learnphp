...
function printLoginHTML(){
	...
	html+='                            <li class="a2"><a st_t="click" st_n="nav_my_upload" href="http://'+domain+appname+'tomyWorks.do">我上传的</a></li>';
	html+='                            <li class="a3"><a st_t="click" st_n="nav_my_recommend" href="http://'+domain+appname+'tomyRecommend.do">我推荐的</a></li>';
	html+='                            <li class="a4"><a st_t="click" st_n="nav_my_comment" href="http://'+domain+appname+'tomyComments.do">我评论的</a></li>';
	html+='                            <li class="a8"><a st_t="click" st_n="nav_my_team" href="http://'+domain+appname+'zteam">我的团队</a></li>';
	html+='                            <li class="a5"><a st_t="click" st_n="nav_my_record" href="http://'+domain+appname+'torecordVisit.do">系统记录</a></li>';
