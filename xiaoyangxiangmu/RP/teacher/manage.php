...
<div class="container-fluid" >
    ...
    <div class="row">
        ...
        while ($row = mysql_fetch_assoc($result)){
            echo "<div class=\" col-sm-6 col-md-4 alert alert-dismissible\" role=\"alert\">
  <button data-id={$row['id']} type=\"button\" class=\"close\" data-dismiss=\"alert\"><span aria-hidden=\"true\">&times;</span><span class=\"sr-only\">Close</span></button>
    ...
    $(".alert-dismissible button").on("click",function () {
        ...
        $.ajax({
            ...
            success:function (data) {
                console.log(data);
                if (data.err==0){
                    _this.parent(".alert-dismissible").remove();
                }else{
                    alert("删除失败,请检查网络")
                }
            }
